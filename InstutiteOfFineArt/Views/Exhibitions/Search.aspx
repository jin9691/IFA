<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="InstutiteOfFineArt.Views.Exhibitions.Search" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSite" runat="server">
    <div class="management-main container">
            ...
            <form method="Post" action="Search.aspx">
                <div class="col-md-8 pull-left">
                    <div class="input-group">
                        <input type="text" name="txtSearch" class="form-control input-lg" placeholder="Insert Exhibition Name Here...">
        ...
        <br/>
        <div>
            <form id="frmSearch" runat="server" method="post">
