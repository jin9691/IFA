...
<div class="wall">
	<div id="pg_container" class="pg_container">
		<ul id="pg_photos" class="pg_photos"><!-- calculate top-->
			<li><a href="#1"><img src="../../Assets/Images/Paintings/1.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#2"><img src="../../Assets/Images/Paintings/2.jpg" alt="A description"/></a></li>
			<li><a href="#3"><img src="../../Assets/Images/Paintings/3.jpg" alt="Another descritpion of the image"/></a></li>
			<li><a href="#4"><img src="../../Assets/Images/Paintings/4.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#5"><img src="../../Assets/Images/Paintings/5.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#6"><img src="../../Assets/Images/Paintings/6.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#7"><img src="../../Assets/Images/Paintings/7.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#8"><img src="../../Assets/Images/Paintings/8.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#9"><img src="../../Assets/Images/Paintings/9.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#10"><img src="../../Assets/Images/Paintings/10.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#11"><img src="../../Assets/Images/Paintings/11.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#12"><img src="../../Assets/Images/Paintings/12.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#13"><img src="../../Assets/Images/Paintings/13.jpg" alt="Here comes a description"/></a></li>
			<li><a href="#14"><img src="../../Assets/Images/Paintings/14.jpg" alt="Here comes a description"/></a></li>
		</ul>
	</div>
</div>
<div class="co-footer">
