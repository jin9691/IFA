    ...
    <form id="Form1" runat="server">
                        ...
                        <div class="ca-item ca-item-1">
                            ...
                            <div class="ca-content-wrapper">
                                <div class="ca-content">
                                    <h6><%# Eval("ExhibitionName") %></h6>
                                    <a href="#" class="ca-close">close</a>
                                    <div class="ca-content-text">
                                        <p class="desc"><%# Eval("ExhibitionDescription") %></p>
                                    </div>
                                    <ul>
                                        <p id="desc" style="display: none"><%# Eval("ExhibitionDescription") %></p>
                                        <p id="id-com" style="display: none"><%# Eval("Id") %></p>
                                        <p id="start" style="display: none"><%# String.Format("{0:dd/MM/yyyy}",Eval("StartDate")) %></p>
                                        <p id="end" style="display: none"><%# String.Format("{0:dd/MM/yyyy}",Eval("EndDate")) %></p>
                                        <p id="manager" style="display: none"><%# Eval("ManagerId") %></p>
                                        <li><a href="Show.aspx?ID=<%# Eval("Id") %>" class="btn btn-primary btn-sm">All images</a></li>
                                        <li>
                                            <asp:LinkButton ID="Destroy" runat="server" CommandArgument='<%# Eval("Id")%>' OnClientClick="return processConfirm();" OnClick="Destroy_Click" CssClass="delete-exhibition btn btn-danger btn-sm">
                                            Delete
                                            </asp:LinkButton>
                                        </li>
        ...
        <div class="co-footer">
            <center>
                ...
                <div class="col-md-6">
                    <h1>Exhibition List <a href="#" class="btn btn-primary " id="showRightPush" style="margin-left:60px">Add Exhibition</a></h1>
                </div>
            </center>
        </div>
    </form>
