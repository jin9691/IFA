<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="InstutiteOfFineArt.Views.Competitions.New" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
     Competition Management (Create New Competition)
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSite" runat="server">
    <div class="management-main container">
        <h1>Competition Management <strong><small>(Create New Competition)</small></strong>
        ...
        <div style="padding: 50px">
            <form id="Form1" method="post" runat="server">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th colspan="3"><span style="float:left">Create new competition</span></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
