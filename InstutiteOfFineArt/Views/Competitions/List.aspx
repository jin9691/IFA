...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSite" runat="server">
                ...
                <div class="ca-content-wrapper">
                    <div class="ca-content">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="btn btn-success btn-sm">Remark</a></li>
                            <li><a href="#" class="btn btn-danger btn-sm">Delete</a></li>
    ...
    <div class="co-footer">
        <center>
            <h1>Competitions <a href="#" class="btn btn-primary btn-lg" style="margin-left:60px">Add Competition</a></h1>
        </center>
    </div>
