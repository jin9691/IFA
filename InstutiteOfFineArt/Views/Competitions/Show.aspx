            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Set Award</h4>
                    </div>
                            ...
                            <div class="row" style="margin-top: 1%">
                                ...
                                <div class="col-md-6">
                                    <div class="image-desc">
                                        <h2>Student: <strong><small>
                                            <%# Student_Name(Eval("StudentId"))%></small></strong>
                                            <asp:LinkButton ID="Destroy" CommandArgument='<%# Eval("Id")%>' OnClick="lbtDelete_Click" OnClientClick="return processConfirm();" CssClass="btn btn-danger btn-sm pull-right" runat="server">Delete</asp:LinkButton>

                                            <p id="desc" style="display: none"><%# Eval("PaintingDescription") %></p>
                                            <p id="remark" style="display: none"><%# Eval("Comment") %></p>
                                            <p id="id-paint" style="display: none"><%# Eval("Id") %></p>

                                            <a href="#" class="edit-desc btn btn-info btn-sm pull-right"
                                                style="margin-left: 5px; margin-right: 5px">Edit</a>
                                            <a href="#" class="edit-remark btn btn-warning btn-sm pull-right"
                                                style="margin-left: 5px">Remark</a>

                                            <a href="#" id='<%# Eval("Id")%>' class="award btn btn-success btn-sm pull-right"
                                                style="margin-left: 5px">Award</a>

                                            <div class="btn-group pull-right">
                                                <a href="#" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown"
                                                    style="margin-left: 5px">Mark <span style="margin-left: 5px" class="caret"></span></a>
