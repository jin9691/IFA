<%@ Page Title="" Language="C#" MasterPageFile="~/Views/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="InstutiteOfFineArt.Views.Paintings.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Paintings Management (Edit Paintings)
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSite" runat="server">
    <div class="management-main container">
        <h1>Paintings Management <strong><small>(Edit Paintings)</small></strong>
        ...
        <div style="padding: 50px">
            <form id="Form1" method="post" runat="server">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th colspan="3"><span style="float: left">Edit painting</span></th>
                        </tr>
                    </thead>
                    <tbody>
